...
const App = () => {
    ...
    return (<div>
        {!isGameFinish && <div>
            ...
            <Answer level={level} taskBird={taskBird} setRightAnswer={setRightAnswer} clickedId={clickedId} setClickedId={setClickedId} setScore={setScore} />
            <ChangeLevel level={level} setLevel={setLevel} isRightAnswer={isRightAnswer} setRightAnswer={setRightAnswer} setTaskBird={setTaskBird} setClickedId={setClickedId} score={score} setScore={setScore} setGameFinish={setGameFinish}/>
        </div>}
